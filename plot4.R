...
#plot
png(filename = "G:/Exploratory Analysis/Week One/exdata_data_household_power_consumption/plot4.png", width = 480, height = 480)
par(mfrow = c(2, 2))
...
with(feb.1n2, plot(Voltage, ylab = "Voltage", xlab = "datetime", main = "", type = "l", axes = F))
axis(2)
axis(1, at = c(0, 1440, 2880), labels = c("Thu", "Fri", "Sat"))
box()
...
with(feb.1n2, plot(Global_reactive_power, ylab = "Global_reactive_power", xlab = "datetime", main = "", type = "l", axes = F))
axis(2)
axis(1, at = c(0, 1440, 2880), labels = c("Thu", "Fri", "Sat"))
box()
